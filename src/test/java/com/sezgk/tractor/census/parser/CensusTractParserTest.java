...
public class CensusTractParserTest
{
    ...
    public void parse()
    {
        ...
        assertTract(tracts.get(0), 24001000100L, 3718, "39.6365143", "-78.5094487");
        assertTract(tracts.get(1), 24001000200L, 4564, "39.6123087", "-78.7031084");
        assertTract(tracts.get(2), 24001000300L, 2780, "39.7083649", "-78.7434027");
        assertTract(tracts.get(3), 24001000400L, 3022, "39.684418", "-78.7270888");
        assertTract(tracts.get(4), 24001000500L, 2734, "39.6562943", "-78.7293926");
        assertTract(tracts.get(5), 24001000600L, 2965, "39.6409546", "-78.7398353");
        assertTract(tracts.get(6), 24001000700L, 3387, "39.6329587", "-78.7526552");
        assertTract(tracts.get(7), 24001000800L, 2213, "39.6288831", "-78.7630037");
        assertTract(tracts.get(8), 24001001000L, 2547, "39.6576457", "-78.7684363");
        assertTract(tracts.get(9), 24001001100L, 1493, "39.6510064", "-78.7722271");
    }
     ...
     */
    public void assertTract(CensusTract tract, long geoid, long population, String latitude, String longitude)
    {
        assertTrue(tract.getGeoId() == geoid);
